...
const listaMista = ["texto", 42, true, { nome: "obj" }];
...
const dadosLegados = obterDadosDeBibliotecaJavaScript();
...
let config = carregarConfiguracao();
